...
class Main:
    ...
    def do_data():
        ...
        values = "46272985,4030271,4097489,4084364,4083951,37152689"
        ob_concepts = values.split(",")
        ...
        ob_types = values.split(",")

        values = "8532,8507"
        genders = values.split(",")

        values = "38003575,38003580,38003613,38003606,8515,38003579,38003597,38003584,38003577,38003591,38003611,38003593,38003615,38003592,38003616,38003587,38003574,38003583,38003604,38003605,38003585,38003576,38003596,38003610,38003607,8527,38003612,38003614,38003586,38003609,38003603,38003572,38003598,8657,38003573,38003594,8516,38003600,38003599,38003590,38003595,38003588,38003581,38003608,38003578,8557,38003602,38003582,38003589,38003601"
        race = values.split(",")

        values = "38003563,38003564"
        ethnicity = values.split(",")
